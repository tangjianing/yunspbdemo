...
<head>
	...
	<body lang="zh-CN">
    	...
    	<div style="overflow: hidden;">
    		<img src="images/ktz.jpg" style="width: 116%;margin-left: -8%;"/>
    	</div>
		<!--END TOP-->
		<div class="container">
								...
								<table id="fixHead">
									<thead>
										<tr>
											...
											<td style="width: 16%;">管理员</td>
											<td style="width: 16%;">配额(GB)</td>
											<td style="width: 16%;">启用时间</td>
											<td style="width: 16%;">过期时间</td>
	                ...
	                success: function(response){
	                		...
	                		if(data.length>0){
	                			for(var i=0;i<data.length;i++){
	               	             html += '<tr>';
							     html += '<td style="width: 20%;">' + data[i].orgName + '</td>';	
							     html += '<td style="width: 16%;">' + data[i].adminName + '</td>';	
							    if(data[i].quota==""||data[i].quota==null){
							    	html += '<td colspan="4" style="">暂未申请资源</td>';
							    }else{
							    	 if(data[i].valid=="通过"){
								     ...
								     html += '<td style="width: 16%;">' + data[i].dt_start + '</td>';
								     html += '<td style="width: 16%;">' + data[i].dt_expired + '</td>';
								     html += '<td style="width: 10%;">' + data[i].valid + '</td>';	
							    }
							     /* if(data[i].valid=="通过"){
