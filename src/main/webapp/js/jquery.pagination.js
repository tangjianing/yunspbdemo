...
;(function($,window,document,undefined){
	...
	var Pagination = function(element,options){
		...
		this.filling = function(index){
			...
			html += opts.jump ? '<span style="margin-left:10px;">跳至</span><input type="text" class="'+opts.jumpIptCls+'"><span>页</span><a href="javascript:;" class="'+opts.jumpBtnCls+'">'+opts.jumpBtn+'</a>' : '';
